...
public class CartHandler implements Initializable{
	//@FXML
    private TableColumn<TraDKProduct, Integer> countCol;

    //@FXML
    private TableColumn<TraDKProduct, Boolean> deleteCol;
	...
	public void initTable() {
		...
		countCol.setCellValueFactory(new PropertyValueFactory<TraDKProduct, Integer>("count"));
		deleteCol.setCellValueFactory(new PropertyValueFactory<TraDKProduct, Boolean>("delete"));
		// Show table data
